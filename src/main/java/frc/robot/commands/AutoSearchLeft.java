...
/**
 * A Command class for searching for an object to the left using limelight.
 *
 * <p>This class uses limelight to search counterclockwise to center the view on a limelight target
 */
public class AutoSearchLeft extends CommandBase {
    ...
    /**
    * A constructor for the AutoSearchLeft command.
    *
    ...
    */
    public AutoSearchLeft(SwerveDriveSubsystem swerveDriveSubsystem, LimeLightSubsystem limeLightSubsystem,
            int pipeline) {

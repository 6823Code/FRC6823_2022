...
public class SwerveWheelModuleSubsystem extends SubsystemBase {
    ...
    public void drive(double speed, double angle) {
        ...
        SmartDashboard.putNumber("Actual Angle", angleMotor.getSelectedSensorPosition());

        SmartDashboard.putNumber("Encoder [" + angleEncoderChannel + "] currentEncoderValue", angleMotor.getSelectedSensorPosition());
    }

...
public class SwerveDriveSubsystem extends SubsystemBase {
     ...
     * of Franklin, WI.
     */
    public final double L = Constants.RobotLength;
    public final double W = Constants.RobotWidth; // These are the Length and Width between wheels.
    // CHANGE THESE in Constants.java IF THE ROBOT IS NOT A SQUARE
